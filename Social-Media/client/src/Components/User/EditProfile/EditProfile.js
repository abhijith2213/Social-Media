                  ...
                  <div class='w-full md:w-1/4 p-4 sm:p-6 lg:p-8 bg-white shadow-md'>
                     ...
                     <div className='flex flex-col gap-4'>
                        <h2
                           className={
                              Select
                                 ? "bg-blue-400 text-white px-2 rounded-md cursor-pointer text-lg"
                        ...
                        <div class='rounded  shadow p-6'>
                           <div class='pb-6'>
                              <div className='flex items-center gap-6 mb-2'>
                                 <img
                                    id='showImage'
                                    class='max-w-xs w-24 h-24 items-center border rounded-full'
                                    src={userData?.profilePic ? PF + userData.profilePic : profile}
                                    alt=''
                                 />
                                 <div className='block'>
                                    <label for='name' class='font-semibold text-gray-700 block pb-1 text-xl'>
                                       {userData.userName}
                                    </label>
                                    <label
                                       for='name'
                                       class='font-semibold text-blue-400 block pb-1'
                              ...
                              <div class='mb-2'>
                                 <label for='fullName' class='font-semibold text-gray-700 block pb-1'>
                                    Full Name
                                 </label>
                                 <input
                                    name='fullName'
                                    class='border rounded focus:outline-none rounded-r px-4 py-2 w-full'
                                    type='text'
                              ...
                              <div class='mb-2'>
                                 <label for='userName' class='font-semibold text-gray-700 block pb-1'>
                                    user Name
                                 </label>
                                 <input
                                    name='userName'
                              ...
                              <div class='mb-2'>
                                 <label for='bio' class='font-semibold text-gray-700 block pb-1'>
                                    About You
                                 </label>
                                 <textarea
                                    name='about'
                        ...
                        <div class='rounded  shadow p-6'>
                           <div class='pb-6'>
                              <div className='flex items-center gap-6 mb-2'>
                                 ...
                                 />
                                 <div className='block'>
                                    <label for='name' class='font-semibold text-gray-700 block pb-1 text-2xl'>
                                       {userData?.userName}
                                    </label>
                                 </div>
                              </div>
                              <label for='oldPassword' class='font-semibold text-gray-700 block pb-1'>
                                 Old Password
                              </label>
                  ...
                  <div className='relative w-auto my-6 mx-auto max-w-sm'>
                     ...
                     <div className='border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none'>
                        <div className='flex items-start justify-between p-5 border-b border-solid border-slate-200 rounded-t'>
                           <h3 className='text-xl font-semibold'>Change Profile Photo</h3>
                        </div>
                        {/*body*/}
                        ...
                        <div
                           className='flex cursor-pointer  items-center justify-center p-3 border-t border-solid border-slate-200 rounded-b'
                        ...
                        <div className='flex cursor-pointer  items-center justify-center p-3 border-t border-solid border-slate-200 rounded-b'>
                           <button
                              className='text-gray-700 text-center background-transparent font-medium  px-6  text-sm outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150'
                              type='button'
               ...
               <div className='justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none'>
                  <div className='relative w-auto my-6 mx-auto max-w-lg'>
                     ...
                     <div className='border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none'>
                        {/*header*/}
                        <div className='flex items-start justify-between p-5 border-b border-solid border-slate-200 rounded-t'>
                           <h3 className='text-3xl font-semibold'>Update Profile Picture</h3>
                           <button
