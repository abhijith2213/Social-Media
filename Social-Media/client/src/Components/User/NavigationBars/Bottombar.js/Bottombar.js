         ...
         <div className='border shadow-md  bg-white fixed top-0 w-full md:hidden'>
            <div className='flex justify-between items-center relative p-3 '>
               <div className='flex items-center justify-between'>
                  <img className='w-20 h-auto ' src={log} alt='talentf' />
               </div>
              <div className="">
                            ...
                            {console.log(user)}
                             <Link to={`/profile/${user.userName}`}>
                                <a class='flex items-center px-3 py-2 text-sm transition duration-150  ease-in-out  cursor-pointer hover:bg-gray-100 focus:outline-none'>
                                   <img class='object-cover w-10 h-10 rounded-full' src={PF + user.profilePic} alt='' />
            ...
            {open ? (
              ...
              {/* MODAL  */}
        {modal ? <div class=' flex-col space-y-4 min-w-screen h-screen animated fadeIn faster  fixed  left-0 top-0 flex justify-center items-center inset-0 z-50 outline-none focus:outline-none  bg-white bg-opacity-50'>
