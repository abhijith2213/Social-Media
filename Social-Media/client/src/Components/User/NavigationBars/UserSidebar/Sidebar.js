               ...
               {menus?.map((menu, i) => (
                  ...
                  >
                     ...
                     {menu.notifications && notifications !== 0 ? (
                        <p className='px-2 text-white bg-red-600 rounded-lg'>{notifications}</p>
                     ) : null}
                  </NavLink>
               ))}
               <div
                  ...
                  <div className='flex items-center justify-between'>
                     <div className='flex items-center'>
                        ...
                        <div className='flex flex-col ml-3'>
                           <div className='font-medium leading-none text-gray-100'>Are you Sure to Logout ?</div>
                  ...
                  <div className=' bg-white rounded-lg shadow dark:bg-gray-700'>
                     ...
                     <div className='p-6'>
                        <ul className='my-4 space-y-3 max-h-[50%] overflow-y-auto no-scrollbar'>
                           {serachUser.length !== 0
                              ? serachUser.map((user) => (
                                 <Link to={`/profile/${user.userName}`}><li className="m-2" onClick={()=>setSearchModal(false)}>
