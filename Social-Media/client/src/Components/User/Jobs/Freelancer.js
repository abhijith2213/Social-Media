                           ...
                           {job?.work === "open" ? (
                              <>
                                 {job?.requests.includes(userId) ? (
                                    <button
                                       class='disabled:bg-blue-300 cursor-not-allowed flex items-center gap-2 text-white font-bold py-2 px-4 rounded'
                                       disabled
                                    >
                                    ...
                                    <button
                                       class='bg-blue-500 hover:bg-blue-700 flex items-center gap-2 text-white font-bold py-2 px-4 rounded'
                              ...
                              <button
                                 ...
                                 type='button'
                                 class='text-blue-500 bg-white hover:bg-gray-100 border border-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 mb-2'
                              >message
                              </button>
                           )}
                        </div>
                  ...
                  <div className='relative w-auto my-6 mx-auto max-w-sm'>
                     ...
                     <div className='border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none'>
                        ...
                        <div className='flex items-center justify-end p-3 border-t border-solid border-slate-200 rounded-b'>
                           ...
                           <button
                              class='bg-cyan-600 hover:bg-red-400 text-white font-bold py-1 px-4 rounded inline-flex items-center disabled:bg-cyan-100'
                              onClick={handleBlock}
                              disabled={!reason}
                           >
                              <span>Submit</span>
